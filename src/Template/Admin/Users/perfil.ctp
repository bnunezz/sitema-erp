<div class="d-flex">
    ...
    <div class="p-2">
        ...
        <span class=" d-none d-md-block">
            ...
            <?= $this->Html->link(__('Editar Perfil'), ['controller' => 'users', 'action' => 'editPerfil'], ['class' => 'btn btn-outline-warning btn-sm']); ?>
            <?= $this->Html->link(__('Editar Senha de perfil'), ['controller' => 'users', 'action' => 'editSenhaPerfil'], ['class' => 'btn btn-outline-danger btn-sm']); ?>
        ...
        <div class="dropdown d-block d-md-none">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoeslistar">
                ...
                <?= $this->Html->link(__('Editar Usuário'), ['controller' => 'users', 'action' => 'editPerfil'], ['class' => 'dropdown-item']); ?>
                <?= $this->Html->link(__('Editar Senha de perfil'), ['controller' => 'users', 'action' => 'editSenhaPerfil'], ['class' => 'dropdown-item']); ?>
