                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="d-none d-md-block">
                            ...
                            <?= $this->Html->link(__('<i class="fas fa-angle-double-up"></i>'), ['controller' => 'Carousels', 'action' => 'altOrdemCarousel', $carousel->id], ['class' => 'btn btn-outline-info btn-sm', 'escape' => false]) ?>
