<div class="d-flex">
    <div class="mr-auto p-2">
        <h2 class="display-4 titulo">Contatos</h2>
    </div>
    <div class="p-2">
        <span class="d-none d-md-block">
            ...
            <?= $this->Form->postLink(__('Apagar'), ['controller' => 'ContatosMsgs', 'action' => 'delete', $contatosMsg->id], ['class' => 'btn btn-outline-danger btn-sm', 'confirm' => __('Relamente deseja apagar o contatosMsg # {0}?', $contatosMsg->id)]) ?>
        ...
        <div class="dropdown d-block d-md-none">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                ...
                <?= $this->Form->postLink(__('Apagar'), ['controller' => 'ContatosMsgs', 'action' => 'delete', $contatosMsg->id], ['class' => 'dropdown-item', 'confirm' => __('Relamente deseja apagar o contatosMsg # {0}?', $contatosMsg->id)]) ?>
            </div>
        </div>
    </div>
</div>
...
<dl class="row">
    ...
    <dd class="col-sm-9"><?= h($contatosMsg->user_id) ?></dd>

    <dt class="col-sm-3">Situação</dt>
    <dd class="col-sm-9"><?= "<span class= 'badge badge-". $contatosMsg->conts_msgs_sit->color->cor . "'>". $contatosMsg->conts_msgs_sit->nome_sit_msg_cont . "</span>"; ?></dd>
